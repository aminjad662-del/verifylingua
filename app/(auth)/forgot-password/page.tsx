...
export const metadata: Metadata = {
  title: "Reset Vault Password | VerifyLingua Certified Translations",
  description:
    "Request a secure cryptographic password reset link for your VerifyLingua certified translation vault.",
};
            ...
            <div className="bg-surface rounded-xl border border-border/60 p-6 sm:p-8">
              <div className="mb-6 text-center">
                ...
                <p className="text-xs text-text-muted mt-1.5">
                  Enter your official email address to receive a secure password recovery link.
                </p>
              </div>
              ...
              <React.Suspense
                fallback={
                  <div className="h-48 flex items-center justify-center text-text-muted text-sm gap-2">
                    ...
                    <span>Loading recovery options...</span>
                  </div>
                }
              >
                <ForgotPasswordForm />
